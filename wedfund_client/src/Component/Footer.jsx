                ...
                <div className="container bottom_footer" style={{ paddingTop: "100px"}}>
                    ...
                    <div className="row mt-3 mb-4 pb-5">
                        <div className="col-md-6">
                            ...
                            <a className='btn btn-footer' style={{border: '2px solid #6c0505', background: '#6c0505', color: '#fff', fontWeight:'500'}} href='https://www.lendingkart.com/business-loan/sme/Wedfund?lksrc=c3JjPVdlZGZ1bmQmdHlwZT1lY29tJnJlZmlkPVdlZGZ1bmQwMDE' rel="noreferrer noopener" target='_blank'>Apply Now</a>
                        </div>
                        <div className="col-md-4 offset-md-1 careerBottom1">
                            ...
                            <div className='socialSection'>
                                ...
                                <h5 className='h5Edit'><a href='https://www.linkedin.com/company/wedfund/' style={{color:'#000'}} rel="noreferrer noopener" target='_blank'><i className="fa-brands fa-linkedin mx-3"></i></a><a href='https://instagram.com/wed.fund?igshid=MzNlNGNkZWQ4Mg==' style={{color:'#000'}} rel="noreferrer noopener" target='_blank'><i className="fa-brands fa-instagram mx-2"></i></a></h5>
                            </div>
                        </div>
                    </div>
                </div>
