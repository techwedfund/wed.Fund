        ...
        <div className=''>
            <div className='container backImg'>
                ...
                <div className='text-center mt-5'>
                    <a href="https://www.lendingkart.com/business-loan/sme/Wedfund?lksrc=c3JjPVdlZGZ1bmQmdHlwZT1lY29tJnJlZmlkPVdlZGZ1bmQwMDE" className='btn btn_Hero' target='_blank'>Apply Now</a>
                </div>
                <div className='row'>
